...
|  [counterexamplePath](RunDetails.md#counterexamplepath) | <code>string &#124; null</code> | In case of failure: path to the counterexample<!-- -->For replay purposes, it can be forced in , , [sample()](sample_1.md) and [statistics()](statistics_1.md) using [Parameters](Parameters.md) |
...
|  [seed](RunDetails.md#seed) | <code>number</code> | Seed that have been used by the run<!-- -->It can be forced in , , [sample()](sample_1.md) and [statistics()](statistics_1.md) using [Parameters](Parameters.md) |
...
For replay purposes, it can be forced in , , [sample()](sample_1.md) and [statistics()](statistics_1.md) using [Parameters](Parameters.md)
