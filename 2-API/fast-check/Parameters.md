...
|  Method | Description |
|  --- | --- |
|  [logger(v)](Parameters.md#logger) | Logger (see [statistics()](statistics_1.md)<!-- -->): <code>console.log</code> by default |
